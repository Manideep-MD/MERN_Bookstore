...
const Navbar = () => {
  ...
  return (
    <div
      className={`max-w-[100%]  fixed top-0 left-0 right-0 dark:bg-slate-900 dark:text-white container mx-auto md:px-20 px-4 z-20  ${
        sticky
          ? "sticky-navbar bg-base-200 shadow-md dark:bg-slate-900 dark:text-white duration-300 ease-in-out transition-all"
          : ""
      }`}
    >
        ...
        <div className="navbar-end space-x-3 dark:bg-slate-900 dark:text-white">
          ...
          <div>
            <label className="swap swap-rotate">
              ...
              <input
                type="checkbox"
                className={`theme-controller ${sticky ? "bg-base-200" : ""}`}
                value="synthwave"
              />

              {/* sun icon */}
              <svg
                className="swap-off h-8 w-8 fill-current dark:bg-slate-900 dark:text-white"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              {/* moon icon */}
              <svg
                className="swap-on h-8 w-8 fill-current dark:bg-slate-900 dark:text-white"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
